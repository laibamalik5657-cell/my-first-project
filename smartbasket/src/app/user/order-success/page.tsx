...
import { ArrowBigDown, ArrowRight, CheckCircle, LockIcon, Package } from 'lucide-react'
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
            ...
            <motion.div
                ...
                transition={{
                    delay: 1, duration: 3, repeat: Infinity, ease: "easeInOut"
                }}
                className='absolute top-0 w-full left-0 h-full pointer-events-none'
            >
                ...
                <div className='absolute top-16 left-[70%] w-2 h-2 bg-green-400 rounded animate-pulse' />
            </motion.div>
