...
const verifyOtp = async ()=>{
  ...
  try {
   ...
   await fetchCurrentOrder// Close OTP box after verification
    ...
    return (
        <div className='p-4 pt-[120px] min-h-screen bg-gray-50'>
            <div className='max-w-3xl mx-auto'>
                ...
                <p className='text-gray-600 text-sm mb-4'>Order #{activeOrder.order_id.slice(-6)}</p>
        ...
        {assignments.map((a,index) => (
          <div key={index} className='p-5 bg-white rounded-xl shadow mb-4 border'>
            ...
            <div className='flex gap-3 mt-4'>
              <button className='flex-1 bg-green-600 text-white py-2 rounded-lg' onClick={()=>handleAccept(a._)}>Accept</button>
