                ...
                <div className='mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between'>
                    <div className='flex items-center gap-3 text-sm text-gray-700'>
                        ...
                        <div className='font-semibold text-gray-800'>
                            ...
                            <p className='text-xs text-gray-600'>📞 +92 {order.assignedDeliveryBoy.mobile}</p>
                        </div>
                    </div>
...
text-white font-semibold px-4 py-2 rounded-xl shadow hover:bg-green-700
transition' onClick={()=>router.push(`/user/track-order ${order._id?.toString()}`)}>
...
border-gray-200"/>
                                        ...
                                        <div>
                                            ...
                                            <p className='test:sm font-medium text-gray-800'>{item.name}</p>

                                            <p className='test:xs text-gray-500' >{item.quantity}*{item.unit}</p>
...
<div className='border-t pt-3 mt-3 flex justify-between items-center text-sm font-semibold
text-gray-800'>
    <div className='flex items-center gap-2 text-gray-700 text-sm'>
    <Truck size={16} className="text-green-600"/>
